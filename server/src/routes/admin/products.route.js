...
router.post('/products', authenticateToken, productController.products.createOne);
...
router.patch('/product/update_categories', authenticateToken, productController.products.updateCategory);
