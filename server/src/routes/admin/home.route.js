...
router.post('/highlight_stats_about_us', homeController.highlight_stats_about_us.createOne);
...
router.patch('/highlight_stats_about_us/:id', homeController.highlight_stats_about_us.updateOne);

router.delete('/highlight_stats_about_us/:id', homeController.highlight_stats_about_us.deleteOne);
