...
const productServices = {
    ...
    products: {
        getList: async (query = '', filter = '', is_featured = '', is_sale = '', page = 1, limit) => 
            fetchData(API_ROUTES.product.products.getList(query, filter, is_featured, is_sale, page, limit)),
        getListByCategory: async (id, query ='', filter ='', is_featured, is_sale = '', limit) => 
            fetchData(API_ROUTES.product.products.getListByCategory(id, query, filter, is_featured, is_sale, limit)),
