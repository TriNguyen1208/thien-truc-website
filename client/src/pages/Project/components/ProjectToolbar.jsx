...
const ProjectsToolbar = React.forwardRef(({ categories, idSelectedCategories, handleClick, scrollTargetRef }, ref) => {
    return (
        <div ref={scrollTargetRef} className="container-fluid">
