export default function Card({
    ...
    return(
        <div 
            onClick={handleClick} 
            className="flex flex-col relative w-full h-full p-[24px] bg-white border border-[#E5E7EB] rounded-[8px] cursor-pointer hover:shadow-md hover:scale-105 transition-all duration-300 ease-in-out"
        >
