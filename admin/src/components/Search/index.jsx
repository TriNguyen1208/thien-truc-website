...
//         (displayMap !== null || display == null || display === displays[0])
//             ? null
//             : ((display === "Đã xuất bản" || display === "Trưng bày") ? true : false)
//     );
//     //Cap nhat displaySuggestion
//     const stableSuggestion = useMemo(()=>{
//         // return Array.isArray(suggestions) ? suggestions : [];
...
//         if (displayMap != null){
//             return suggestions.filter((item) => {
//                 const displayVal = displayMap.get(item.id) || "Chưa gán";
//                 if (display === "Tất cả trạng thái") return true;
//                 return display == displayVal
//             })
//         };
//         return suggestions;
