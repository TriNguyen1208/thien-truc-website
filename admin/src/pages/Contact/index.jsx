...
const Contact = () => {
    ...
    //Lưu giá trị của support agents khi vừa mới fetch
    useEffect(()=>{
        if(supportAgents){
    ...
    //Nếu như có bấm vào nút add contact thì mở popup
    function handleAddContact(){
        setIsModalOpenAdd(true)
    }
    function handleCancelButtonAdd() {
        setIsModalOpenAdd(false)
    }
    function handleCancelButtonEdit() {
        setIsModalOpenEdit(false)
    }
    const configAdd = {
        ...
        return (
            [ 
                ...
                }, 
                {
                    ...
                    component: 
                        <div> 
                            <ProductImageCell imageUrl = {contact.avatar_img} productName = {"Nhân viên"} />
                        </div>
                },
                {
                    type: "text", 
                    content: contact.name === '' ? 'Cập nhật sau': contact.name
                }, 
                {
                    type: "text", 
                    content: contact.role  === '' ? 'Cập nhật sau': contact.role
                },
                {
                    type: "text", 
                    content: contact.phone_number  === '' ? 'Cập nhật sau': contact.phone_number
                },
                {
                    type: "text", 
                    content: contact.facebook_url  === '' ? 'Cập nhật sau': contact.facebook_url
                },
                {
