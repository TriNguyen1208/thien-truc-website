...
const Company = () => {
    ...
    const handleDeleteAddress = (e)=>{
        ...
        const handleAddAddress = ()=>{
            setCompanyAddressList(prev=> (
                [...prev, { address: "", googlemaps_url: "", id: nextAddressId}] 
            ))
    ...
    const handleHourChange = (id, value) => {
        setCompanyHourList(prev => prev.map(hour => hour.id === id ? { ...hour, data: value } : hour));
    };
    //=========================Phone Company============================
    const phoneButton = {
        Icon: PlusIcon,
        ...
        padding :3, 
        handleButton:()=> {
            setCompanyPhoneList(prev=> ([...prev, {id: nextPhoneId , data: ""}]))
    ...
    const handlePhoneChange = (id, value) => {
        setCompanyPhoneList(prev => prev.map(phone => phone.id === id ? { ...phone, data: value } : phone));
    };
    //=========================Hotline============================
    const hotlineButton = {
        Icon: PlusIcon,
        ...
        padding :3, 
        handleButton:()=>{
            setCompanyHotlineList(prev=> ([...prev, {id: nextHotlineId , data: ""}]))
    ...
    const handleHotlineChange = (id, value) => {
        setCompanyHotlineList(prev => prev.map(hotline => hotline.id === id ? { ...hotline, data: value } : hotline));
    };
    //=============================================================
    const submitButton = {
        Icon: SaveIcon,
    ...
    return (
        <form onSubmit={handleSubmit} className='flex flex-col bg-white p-[24px] border border-gray-300 rounded-[8px] gap-[24px]'>
            <div className=' flex flex-col'>
                <h1 className='text-[24px] text-black font-semibold'>Thông tin liên hệ</h1>
                        ...
                        (companyHourList || []).map((hour, index)=>{
                            return (  
                                <div key={index} data-index = {hour.id} className='flex flex-row gap-[4px] items-center'>
                                    ...
                                    />
                                    {
                                        companyHourList.length >= 2 && 
                                            <div className=' w-[44px] h-[40px] top-[12px] right-[12px]'>
                                                <Button 
                                                    Icon = {DeleteIcon} 
                                                    colorText = {"#000000"} 
                                                    colorBackground = "#FFFFFF" 
                                                    handleButton = {handleDeleteHour}
                                                />
                                            </div>
                                    }
                                </div>)
                        ...
                        (companyPhoneList || []).map((phone, index)=>{
                            return(  
                                <div key={index} data-index = {phone.id} className='flex flex-row gap-[4px] items-center'>
                                    ...
                                    />
                                    {
                                        companyPhoneList.length >= 2 && 
                                            <div className=' w-[44px] h-[40px] top-[12px] right-[12px]'>
                                                <Button 
                                                    Icon = {DeleteIcon} 
                                                    colorText = {"#000000"} 
                                                    colorBackground = "#FFFFFF" 
                                                    handleButton = {handleDeletePhone}
                                                />
                                            </div>
                                    }
                                </div>
                        ...
                        (companyHotlineList || []).map((hotline, index)=>{
                            return(  
                                <div key={index} data-index = {hotline.id} className='flex flex-row gap-[4px] items-center'>
                                    ...
                                    />
                                    {
                                        companyHotlineList.length >= 2 && 
                                            <div className=' w-[44px] h-[40px] top-[12px] right-[12px]'>
                                                <Button 
                                                    Icon = {DeleteIcon} 
                                                    colorText = {"#000000"} 
                                                    colorBackground = "#FFFFFF" 
                                                    handleButton = {handleDeleteHotline}
                                                />
                                            </div>
                                    }
                                </div>)
